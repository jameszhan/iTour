...
class DealsControllerTest < ActionController::TestCase
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post :create, deal: { intro: @deal.intro, price: @deal.price, provider: @deal.provider, type: @deal.type, url: @deal.url }
    end
  ...
  test "should update deal" do
    put :update, id: @deal, deal: { intro: @deal.intro, price: @deal.price, provider: @deal.provider, type: @deal.type, url: @deal.url }
    assert_redirected_to deal_path(assigns(:deal))
  end
